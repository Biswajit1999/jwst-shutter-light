...
def load_config(path: str | Path) -> AnalysisConfig:
    ...
    monte_carlo_raw = _require_section(raw, "monte_carlo")
    ...
    monte_carlo = MonteCarloConfig(
        demo_trials=int(_require(monte_carlo_raw, "demo_trials", "monte_carlo")),
        production_trials=int(_require(monte_carlo_raw, "production_trials", "monte_carlo")),
