# Claude Code Task — JWST/NIRSpec Micro-Shutter Throughput Loss Sandbox
...
5. Implement reusable scientific modules under `src/jwst_nirspec_msa_throughput_sandbox/`; notebooks must only orchestrate imported functions.
